...
> A curated stack of 36+ battle-tested patterns, prompts, and workflows designed to operationalize high-level engineering. From System Architecture to Autonomous Agents, this is the blueprint for the AI-First Developer.
...
- **Quality:** TDD mindsets and testing strategies.
...
- **[`autonomous-agent-expert`](ai-agents/autonomous-agent-expert)**: Reliable agent loops (ReAct/Plan-Execute).
- **[`agent-tool-builder`](ai-agents/agent-tool-builder)**: Designing robust tools & schemas.
- **[`llm-app-patterns`](ai-agents/llm-app-patterns)**: Architecture patterns for LLM Apps.
...
- **[`rag-expert`](ai-agents/rag-expert)**: High-precision RAG systems.
- **[`chatgpt-project-architect`](ai-agents/chatgpt-project-architect)**: Designing Project Instructions.
- **[`meta-skill-antigravity`](ai-agents/meta-skill-antigravity)**: Methodology for creating new skills.

### 🧠 Strategy & Architecture

- **[`senior-architect`](strategy-architecture/senior-architect)**: System design & tradeoffs.
- **[`planning-expert`](strategy-architecture/planning-expert)**: Roadmapping & estimation.
- **[`brainstorming`](strategy-architecture/brainstorming)**: Unblocking creativity.
...
- **[`app-builder`](strategy-architecture/app-builder)**: MVP building guide.

### ⚙️ Backend & Infrastructure

- **[`backend-expert`](backend-infra/backend-expert)**: General backend architecture.
...
- **[`database-design`](backend-infra/database-design)**: Data modeling & normalization.
- **[`postgres-best-practices`](backend-infra/postgres-best-practices)**: Performance & indexing.
...
- **[`testing-patterns`](languages-standards/testing-patterns)**: TDD & Testing strategies.
