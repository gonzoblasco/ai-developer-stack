---
name: readme
description: Expert technical writer guide for creating comprehensive project documentation. Guides directory structure mapping, config file setup, database seeds, and deployment targeting.
risk: safe
