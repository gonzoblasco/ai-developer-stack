...
- **ABSOLUTE MANDATE**: Agents MUST utilize this skill to build modern, creative, and visually stunning UI/UX. DO NOT build in the common style and ways. Look for every opportunity to inject "magic" into standard components. See [ui-ux-pro-max](../ui-ux-pro-max/SKILL.md) and [antigravity-design-expert](../antigravity-design-expert/SKILL.md) for related design and animation guidelines.
...
## Related Skills
- [ui-ux-pro-max](../ui-ux-pro-max/SKILL.md) - Aesthetic styling, guidelines, and matching color schemes.
- [antigravity-design-expert](../antigravity-design-expert/SKILL.md) - Weightless 3D, spatial layout, and GSAP scrolling.
- [tailwind-patterns](../tailwind-patterns/SKILL.md) - Utility styling at scale.
