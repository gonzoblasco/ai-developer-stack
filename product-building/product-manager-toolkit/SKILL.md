...
- Feature prioritization using RICE scoring framework
- Customer discovery — interview analysis and synthesis
- PRD creation using structured templates
- Metrics tracking, funnel analysis, and North Star definition
