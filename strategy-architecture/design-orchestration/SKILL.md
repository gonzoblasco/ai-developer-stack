...
- [brainstorming](../brainstorming/SKILL.md) — design generation
- `multi-agent-brainstorming` — design validation (or multi-agent review loops)
...
- Invoke [brainstorming](../brainstorming/SKILL.md)
- Require:
  - Understanding Lock
  - Initial Design
...
## Related Skills
- [brainstorming](../brainstorming/SKILL.md) - Creative generation of feature ideas.
- [senior-architect](../senior-architect/SKILL.md) - High-level system design, tradeoff analysis, and C4 mapping.
